...
using ResultView = VectorViewTrait<RealType, DeviceMemSpace>::type;
...
{
  ResultView result("result", n_outputs);
  Kokkos::parallel_for(
    "test", device_range_policy(0, 1), KOKKOS_LAMBDA(int) { f(result); });
