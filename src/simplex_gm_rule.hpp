...
int
gm_rule_size(int rule, int dim_num);
void
gm_unit_rule_set(int rule, int dim_num, int point_num, double w[], double x[]);
int
...
double*
monomial_value(int dim_num, int point_num, int expon[], double x[]);
double
r8_factorial(int n);
double
...
double
simplex_unit_monomial_integral(int dim_num, int expon[]);
double
simplex_unit_monomial_quadrature(int dim_num,
                                 int expon[],
                                 int point_num,
                                 double x[],
                                 double w[]);
double*
simplex_unit_sample(int dim_num, int n, int& seed);
void
simplex_unit_to_general(int dim_num,
                        int point_num,
                        double t[],
                        double ref[],
                        double phy[]);
double
simplex_unit_volume(int dim_num);
void
timestamp();
